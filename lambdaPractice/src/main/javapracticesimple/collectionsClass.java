...
public class collectionsClass {
    ...
    private static void CollectionsMethods() {
        ...
        Optional<String> str3= Optional.of(str);
        Optional.empty();
        ...
        hashSet.add("bmw");
        hashSet.add("Audio");
        Optional<String> optionalS = Optional.of("ujssk");
        if(optionalS.isPresent()){
            System.out.println("value is present .");
        }
        Supplier<HashMap<String,String>> supplier = ()->{
        ...
        HashMap<String,String> hashMap1 = supplier.get();
